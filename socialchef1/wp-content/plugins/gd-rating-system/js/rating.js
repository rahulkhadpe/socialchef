    ...
    gdrts_rating_core = {
        ...
        init: function() {
            ...
            $(".gdrts-dynamic-block").each(function(){
                gdrts_rating_dynamic.process(this);
            });
        ...
        stars_rating: {
            _b: function(el, list) {
                var cls = list === true ? ".gdrts-rating-list" : ".gdrts-rating-block";
                return $(el).closest(cls + ".gdrts-method-stars-rating");
            },
            _d: function(el, list) {
                return this._b(el, list).data("rating");
            },
            single: {
                init: function() {
                ...
                call: function(el, rating) {
                    var data = gdrts_rating_core.stars_rating._d(el),
                        args = {
                            todo: "vote",
                            method: "stars-rating",
                ...
                process: function(el) {
                    var data = gdrts_rating_core.stars_rating._d(el, false).stars,
                        labels = gdrts_rating_core.stars_rating._d(el, false).labels;
                ...
                activity: function(el, data, labels) {
                    ...
                    $(".gdrts-stars-empty", el).click(function(e){
                        ...
                        if ($(this).parent().hasClass("gdrts-passive-rating")) return;

                        $(this).addClass("gdrts-vote-saving");

                        gdrts_rating_core.stars_rating._b(this, false).addClass("gdrts-vote-saving");
            ...
            list: {
                ...
                process: function(el) {
                    var data = gdrts_rating_core.stars_rating._d(el, true).stars;
